...
export type WebSocketCommandSubscribe = (InvalidateBase & SubscribeInvalidateDetails) | SubscribeDecoupledOperation;
...
export type SubscribeInvalidateDetails = SubscribeSessions | SubscribePositions | SubscribeOrders;
