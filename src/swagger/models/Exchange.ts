...
} from './PartialRecordOrderModelString';
...
export interface Exchange {
    ...
    /**
     * 
     * @type {PartialRecordOrderModelString}
     * @memberof Exchange
     */
...
export function ExchangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): Exchange {
    ...
    return {
        ...
        'legalMessagesToConfirmByOrderModel': !exists(json, 'legalMessagesToConfirmByOrderModel') ? undefined : PartialRecordOrderModelStringFromJSON(json['legalMessagesToConfirmByOrderModel']),
...
export function ExchangeToJSONRecursive(value?: Exchange | null, ignoreParent = false): any {
    ...
    return {
        ...
        'legalMessagesToConfirmByOrderModel': PartialRecordOrderModelStringToJSON(value.legalMessagesToConfirmByOrderModel),
