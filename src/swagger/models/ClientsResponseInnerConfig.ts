...
} from './RecordBrokerNameEnumBrokerEnvFilterType';
...
export interface ClientsResponseInnerConfig {
    ...
    /**
     * 
     * @type {RecordBrokerNameEnumBrokerEnvFilterType}
     * @memberof ClientsResponseInnerConfig
     */
...
export function ClientsResponseInnerConfigFromJSON(json: any): ClientsResponseInnerConfig {
    return ClientsResponseInnerConfigFromJSONTyped(json, false);
}

export function ClientsResponseInnerConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientsResponseInnerConfig {
...
export function ClientsResponseInnerConfigToJSONRecursive(value?: ClientsResponseInnerConfig | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function ClientsResponseInnerConfigToJSON(value?: ClientsResponseInnerConfig | null): any {
