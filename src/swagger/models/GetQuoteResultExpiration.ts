 ...
 */
export interface GetQuoteResultExpiration {
    /**
     * 
     * @type {Date}
     * @memberof GetQuoteResultExpiration
     */
    expires: Date;
    /**
     * 
...
export function GetQuoteResultExpirationFromJSON(json: any): GetQuoteResultExpiration {
    return GetQuoteResultExpirationFromJSONTyped(json, false);
}

export function GetQuoteResultExpirationFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetQuoteResultExpiration {
...
export function GetQuoteResultExpirationToJSON(value?: GetQuoteResultExpiration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
