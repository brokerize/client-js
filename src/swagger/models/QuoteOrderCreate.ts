 ...
 */
export interface QuoteOrderCreate {
    /**
     * 
     * @type {OrderValidity}
     * @memberof QuoteOrderCreate
     */
...
* @enum {string}
*/
export enum QuoteOrderCreateOrderModelEnum {
    Quote = 'quote'
}

export function QuoteOrderCreateFromJSON(json: any): QuoteOrderCreate {
    return QuoteOrderCreateFromJSONTyped(json, false);
}

export function QuoteOrderCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuoteOrderCreate {
...
export function QuoteOrderCreateToJSON(value?: QuoteOrderCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
