...
export function GenericTableRowValueTextSpecificsFromJSON(json: any): GenericTableRowValueTextSpecifics {
    return GenericTableRowValueTextSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowValueTextSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueTextSpecifics {
...
export function GenericTableRowValueTextSpecificsToJSONRecursive(value?: GenericTableRowValueTextSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function GenericTableRowValueTextSpecificsToJSON(value?: GenericTableRowValueTextSpecifics | null): any {
