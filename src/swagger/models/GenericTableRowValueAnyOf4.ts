 ...
 */
export interface GenericTableRowValueAnyOf4 {
    /**
     * 
     * @type {GenericTableRowValueLink}
     * @memberof GenericTableRowValueAnyOf4
     */
...
* @enum {string}
*/
export enum GenericTableRowValueAnyOf4TypeEnum {
    Link = 'link'
}

export function GenericTableRowValueAnyOf4FromJSON(json: any): GenericTableRowValueAnyOf4 {
    return GenericTableRowValueAnyOf4FromJSONTyped(json, false);
}

export function GenericTableRowValueAnyOf4FromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueAnyOf4 {
...
export function GenericTableRowValueAnyOf4ToJSON(value?: GenericTableRowValueAnyOf4 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
