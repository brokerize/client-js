 ...
 */
export interface GenericTableRowValueAnyOf {
    /**
     * 
     * @type {string}
     * @memberof GenericTableRowValueAnyOf
     */
    value: string;
    /**
     * 
...
* @enum {string}
*/
export enum GenericTableRowValueAnyOfTypeEnum {
    Text = 'text'
}

export function GenericTableRowValueAnyOfFromJSON(json: any): GenericTableRowValueAnyOf {
    return GenericTableRowValueAnyOfFromJSONTyped(json, false);
}

export function GenericTableRowValueAnyOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueAnyOf {
...
export function GenericTableRowValueAnyOfToJSON(value?: GenericTableRowValueAnyOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
