...
export function GenericTableRowSubheadingSpecificsFromJSON(json: any): GenericTableRowSubheadingSpecifics {
    return GenericTableRowSubheadingSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowSubheadingSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowSubheadingSpecifics {
...
export function GenericTableRowSubheadingSpecificsToJSONRecursive(value?: GenericTableRowSubheadingSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function GenericTableRowSubheadingSpecificsToJSON(value?: GenericTableRowSubheadingSpecifics | null): any {
