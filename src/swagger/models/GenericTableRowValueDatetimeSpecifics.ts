...
export function GenericTableRowValueDatetimeSpecificsFromJSON(json: any): GenericTableRowValueDatetimeSpecifics {
    return GenericTableRowValueDatetimeSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowValueDatetimeSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueDatetimeSpecifics {
