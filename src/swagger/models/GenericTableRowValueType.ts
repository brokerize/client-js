...
export function GenericTableRowValueTypeFromJSON(json: any): GenericTableRowValueType {
    return GenericTableRowValueTypeFromJSONTyped(json, false);
}

export function GenericTableRowValueTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueType {
    return json as GenericTableRowValueType;
}

export function GenericTableRowValueTypeToJSON(value?: GenericTableRowValueType | null): any {
    return value as any;
}
