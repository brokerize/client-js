 ...
 */
export interface InlineResponse2004Exchanges {
    /**
     * 
     * @type {string}
     * @memberof InlineResponse2004Exchanges
     */
    name: string;
    /**
     * 
...
export function InlineResponse2004ExchangesFromJSON(json: any): InlineResponse2004Exchanges {
    return InlineResponse2004ExchangesFromJSONTyped(json, false);
}

export function InlineResponse2004ExchangesFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2004Exchanges {
...
export function InlineResponse2004ExchangesToJSON(value?: InlineResponse2004Exchanges | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
