...
export function EnableSessionTanParamsDecoupledSpecificsFromJSON(json: any): EnableSessionTanParamsDecoupledSpecifics {
    return EnableSessionTanParamsDecoupledSpecificsFromJSONTyped(json, false);
}

export function EnableSessionTanParamsDecoupledSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableSessionTanParamsDecoupledSpecifics {
