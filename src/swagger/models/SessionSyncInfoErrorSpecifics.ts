...
export function SessionSyncInfoErrorSpecificsFromJSON(json: any): SessionSyncInfoErrorSpecifics {
    return SessionSyncInfoErrorSpecificsFromJSONTyped(json, false);
}

export function SessionSyncInfoErrorSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionSyncInfoErrorSpecifics {
...
export function SessionSyncInfoErrorSpecificsToJSONRecursive(value?: SessionSyncInfoErrorSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function SessionSyncInfoErrorSpecificsToJSON(value?: SessionSyncInfoErrorSpecifics | null): any {
