...
export function GenericTableRowValueLinkUrlSpecificsFromJSON(json: any): GenericTableRowValueLinkUrlSpecifics {
    return GenericTableRowValueLinkUrlSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowValueLinkUrlSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueLinkUrlSpecifics {
