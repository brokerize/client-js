...
export function SetClientConfigRequestFromJSON(json: any): SetClientConfigRequest {
    return SetClientConfigRequestFromJSONTyped(json, false);
}

export function SetClientConfigRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetClientConfigRequest {
...
export function SetClientConfigRequestToJSONRecursive(value?: SetClientConfigRequest | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function SetClientConfigRequestToJSON(value?: SetClientConfigRequest | null): any {
