...
export type PortfolioSyncInfo =
  | ({ status: "COMPLETE" } & PortfolioSyncInfoComplete)
  | ({ status: "ERROR" } & PortfolioSyncInfoError)
  | ({ status: "INCOMPLETE" } & PortfolioSyncInfoIncomplete)
  | ({ status: "PENDING" } & PortfolioSyncInfoPending);
...
export function PortfolioSyncInfoFromJSONTyped(
  ...
  switch (json["status"]) {
    case "COMPLETE":
      return {
        ...PortfolioSyncInfoCompleteFromJSONTyped(json, true),
        status: "COMPLETE",
      };
    case "ERROR":
      return {
        ...PortfolioSyncInfoErrorFromJSONTyped(json, true),
        status: "ERROR",
      };
    case "INCOMPLETE":
      return {
        ...PortfolioSyncInfoIncompleteFromJSONTyped(json, true),
        status: "INCOMPLETE",
      };
    case "PENDING":
      return {
        ...PortfolioSyncInfoPendingFromJSONTyped(json, true),
        status: "PENDING",
      };
    default:
      throw new Error(
