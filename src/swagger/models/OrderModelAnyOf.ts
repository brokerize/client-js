 ...
 * @enum {string}
 */
export enum OrderModelAnyOf {
    Quote = 'quote',
    Fraction = 'fraction',
    SavingsPlan = 'savingsPlan'
}

export function OrderModelAnyOfFromJSON(json: any): OrderModelAnyOf {
    return OrderModelAnyOfFromJSONTyped(json, false);
}

export function OrderModelAnyOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderModelAnyOf {
    return json as OrderModelAnyOf;
}

export function OrderModelAnyOfToJSON(value?: OrderModelAnyOf | null): any {
    return value as any;
}
