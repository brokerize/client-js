...
export function SessionSyncInfoSyncedSpecificsFromJSON(json: any): SessionSyncInfoSyncedSpecifics {
    return SessionSyncInfoSyncedSpecificsFromJSONTyped(json, false);
}

export function SessionSyncInfoSyncedSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionSyncInfoSyncedSpecifics {
...
export function SessionSyncInfoSyncedSpecificsToJSONRecursive(value?: SessionSyncInfoSyncedSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function SessionSyncInfoSyncedSpecificsToJSON(value?: SessionSyncInfoSyncedSpecifics | null): any {
