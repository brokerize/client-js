...
export function GenericTableRowTextSpecificsFromJSON(json: any): GenericTableRowTextSpecifics {
    return GenericTableRowTextSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowTextSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowTextSpecifics {
