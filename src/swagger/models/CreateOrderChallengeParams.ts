...
export function CreateOrderChallengeParamsFromJSON(json: any): CreateOrderChallengeParams {
    return CreateOrderChallengeParamsFromJSONTyped(json, false);
}

export function CreateOrderChallengeParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateOrderChallengeParams {
