...
export function GetPortfolioOrdersResponseFromJSON(json: any): GetPortfolioOrdersResponse {
    return GetPortfolioOrdersResponseFromJSONTyped(json, false);
}

export function GetPortfolioOrdersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetPortfolioOrdersResponse {
