...
export function NoSessionAvailableForPortfolioFromJSON(json: any): NoSessionAvailableForPortfolio {
    return NoSessionAvailableForPortfolioFromJSONTyped(json, false);
}

export function NoSessionAvailableForPortfolioFromJSONTyped(json: any, ignoreDiscriminator: boolean): NoSessionAvailableForPortfolio {
