...
export function ChangeOrderChallengeParamsFromJSON(json: any): ChangeOrderChallengeParams {
    return ChangeOrderChallengeParamsFromJSONTyped(json, false);
}

export function ChangeOrderChallengeParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeOrderChallengeParams {
...
export function ChangeOrderChallengeParamsToJSONRecursive(value?: ChangeOrderChallengeParams | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function ChangeOrderChallengeParamsToJSON(value?: ChangeOrderChallengeParams | null): any {
