...
export function MustAcceptHintFromJSON(json: any): MustAcceptHint {
    return MustAcceptHintFromJSONTyped(json, false);
}

export function MustAcceptHintFromJSONTyped(json: any, ignoreDiscriminator: boolean): MustAcceptHint {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'hint': HintFromJSON(json['hint']),
        'code': json['code'],
    };
}
