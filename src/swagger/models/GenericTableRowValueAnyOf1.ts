 ...
 */
export interface GenericTableRowValueAnyOf1 {
    /**
     * 
     * @type {string}
     * @memberof GenericTableRowValueAnyOf1
     */
    currency?: string;
    /**
     * 
...
* @enum {string}
*/
export enum GenericTableRowValueAnyOf1TypeEnum {
    Amount = 'amount'
}

export function GenericTableRowValueAnyOf1FromJSON(json: any): GenericTableRowValueAnyOf1 {
    return GenericTableRowValueAnyOf1FromJSONTyped(json, false);
}

export function GenericTableRowValueAnyOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueAnyOf1 {
...
export function GenericTableRowValueAnyOf1ToJSON(value?: GenericTableRowValueAnyOf1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
