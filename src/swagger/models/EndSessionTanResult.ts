 ...
 */
export interface EndSessionTanResult {
    /**
     * 
     * @type {string}
     * @memberof EndSessionTanResult
     */
    message?: string;
}

export function EndSessionTanResultFromJSON(json: any): EndSessionTanResult {
    return EndSessionTanResultFromJSONTyped(json, false);
}

export function EndSessionTanResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): EndSessionTanResult {
...
export function EndSessionTanResultToJSON(value?: EndSessionTanResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
