...
export function PortfolioSyncInfoIncompleteSpecificsFromJSON(json: any): PortfolioSyncInfoIncompleteSpecifics {
    return PortfolioSyncInfoIncompleteSpecificsFromJSONTyped(json, false);
}

export function PortfolioSyncInfoIncompleteSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PortfolioSyncInfoIncompleteSpecifics {
...
export function PortfolioSyncInfoIncompleteSpecificsToJSONRecursive(value?: PortfolioSyncInfoIncompleteSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function PortfolioSyncInfoIncompleteSpecificsToJSON(value?: PortfolioSyncInfoIncompleteSpecifics | null): any {
