...
export function EndSessionTanResponseFromJSON(json: any): EndSessionTanResponse {
    return EndSessionTanResponseFromJSONTyped(json, false);
}

export function EndSessionTanResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EndSessionTanResponse {
