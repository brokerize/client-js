...
export function CreateGuestUserResponseFromJSON(json: any): CreateGuestUserResponse {
    return CreateGuestUserResponseFromJSONTyped(json, false);
}

export function CreateGuestUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateGuestUserResponse {
