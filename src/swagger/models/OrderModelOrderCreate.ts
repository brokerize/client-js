 ...
 * @enum {string}
 */
export enum OrderModelOrderCreate {
    Market = 'market',
    Limit = 'limit',
...
export function OrderModelOrderCreateFromJSON(json: any): OrderModelOrderCreate {
    return OrderModelOrderCreateFromJSONTyped(json, false);
}

export function OrderModelOrderCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderModelOrderCreate {
    return json as OrderModelOrderCreate;
}

export function OrderModelOrderCreateToJSON(value?: OrderModelOrderCreate | null): any {
    return value as any;
}
