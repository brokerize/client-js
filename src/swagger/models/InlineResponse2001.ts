...
} from './InlineResponse2001Accounts';
...
export interface InlineResponse2001 {
    /**
     * 
     * @type {Array<InlineResponse2001Accounts>}
...
export function InlineResponse2001FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2001 {
    ...
    return {
        ...
        'accounts': ((json['accounts'] as Array<any>).map(InlineResponse2001AccountsFromJSON)),
    };
}
...
export function InlineResponse2001ToJSON(value?: InlineResponse2001 | null): any {
    ...
    return {
        ...
        'accounts': ((value.accounts as Array<any>).map(InlineResponse2001AccountsToJSON)),
    };
}
