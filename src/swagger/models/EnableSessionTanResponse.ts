...
export function EnableSessionTanResponseFromJSON(json: any): EnableSessionTanResponse {
    return EnableSessionTanResponseFromJSONTyped(json, false);
}

export function EnableSessionTanResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableSessionTanResponse {
...
export function EnableSessionTanResponseToJSONRecursive(value?: EnableSessionTanResponse | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function EnableSessionTanResponseToJSON(value?: EnableSessionTanResponse | null): any {
