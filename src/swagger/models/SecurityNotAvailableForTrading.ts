...
export function SecurityNotAvailableForTradingFromJSON(json: any): SecurityNotAvailableForTrading {
    return SecurityNotAvailableForTradingFromJSONTyped(json, false);
}

export function SecurityNotAvailableForTradingFromJSONTyped(json: any, ignoreDiscriminator: boolean): SecurityNotAvailableForTrading {
