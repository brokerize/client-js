 ...
 */
export interface CreateOrderParamsWithChallengeResponse {
    /**
     ...
     * @type {string}
     * @memberof CreateOrderParamsWithChallengeResponse
     */
    acceptHintId?: string;
    /**
     * 
...
export function CreateOrderParamsWithChallengeResponseFromJSON(json: any): CreateOrderParamsWithChallengeResponse {
    return CreateOrderParamsWithChallengeResponseFromJSONTyped(json, false);
}

export function CreateOrderParamsWithChallengeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateOrderParamsWithChallengeResponse {
    ...
    return {
        ...
        'order': OrderForCreateFromJSON(json['order']),
        'challengeResponse': json['challengeResponse'],
        'challengeId': json['challengeId'],
    };
}

export function CreateOrderParamsWithChallengeResponseToJSON(value?: CreateOrderParamsWithChallengeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'order': OrderForCreateToJSON(value.order),
