...
export function PortfolioSyncInfoCompleteSpecificsFromJSON(json: any): PortfolioSyncInfoCompleteSpecifics {
    return PortfolioSyncInfoCompleteSpecificsFromJSONTyped(json, false);
}

export function PortfolioSyncInfoCompleteSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PortfolioSyncInfoCompleteSpecifics {
...
export function PortfolioSyncInfoCompleteSpecificsToJSONRecursive(value?: PortfolioSyncInfoCompleteSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function PortfolioSyncInfoCompleteSpecificsToJSON(value?: PortfolioSyncInfoCompleteSpecifics | null): any {
