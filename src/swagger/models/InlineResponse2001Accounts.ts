 ...
 */
export interface InlineResponse2001Accounts {
    /**
     * 
     * @type {string}
     * @memberof InlineResponse2001Accounts
     */
    accountName: string;
    /**
     * 
...
export function InlineResponse2001AccountsFromJSON(json: any): InlineResponse2001Accounts {
    return InlineResponse2001AccountsFromJSONTyped(json, false);
}

export function InlineResponse2001AccountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2001Accounts {
...
export function InlineResponse2001AccountsToJSON(value?: InlineResponse2001Accounts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
