...
export function BrokerEnvFilterTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrokerEnvFilterType {
    return json as BrokerEnvFilterType;
}

export function BrokerEnvFilterTypeToJSON(value?: BrokerEnvFilterType | null): any {
    return value as any;
}
