 ...
 */
export interface RecordBrokerNameEnumBrokerEnvFilterType {
    /**
     * 
     * @type {BrokerEnvFilterType}
     * @memberof RecordBrokerNameEnumBrokerEnvFilterType
     */
...
export function RecordBrokerNameEnumBrokerEnvFilterTypeFromJSON(json: any): RecordBrokerNameEnumBrokerEnvFilterType {
    return RecordBrokerNameEnumBrokerEnvFilterTypeFromJSONTyped(json, false);
}

export function RecordBrokerNameEnumBrokerEnvFilterTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecordBrokerNameEnumBrokerEnvFilterType {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'demo': !exists(json, 'demo') ? undefined : BrokerEnvFilterTypeFromJSON(json['demo']),
        'consors': !exists(json, 'consors') ? undefined : BrokerEnvFilterTypeFromJSON(json['consors']),
        'finanzen': !exists(json, 'finanzen') ? undefined : BrokerEnvFilterTypeFromJSON(json['finanzen']),
        'justtrade': !exists(json, 'justtrade') ? undefined : BrokerEnvFilterTypeFromJSON(json['justtrade']),
        'comdirect': !exists(json, 'comdirect') ? undefined : BrokerEnvFilterTypeFromJSON(json['comdirect']),
        'flatex': !exists(json, 'flatex') ? undefined : BrokerEnvFilterTypeFromJSON(json['flatex']),
        'vitrade': !exists(json, 'vitrade') ? undefined : BrokerEnvFilterTypeFromJSON(json['vitrade']),
    };
}

export function RecordBrokerNameEnumBrokerEnvFilterTypeToJSONRecursive(value?: RecordBrokerNameEnumBrokerEnvFilterType | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'demo': BrokerEnvFilterTypeToJSON(value.demo),
        'consors': BrokerEnvFilterTypeToJSON(value.consors),
        'finanzen': BrokerEnvFilterTypeToJSON(value.finanzen),
        'justtrade': BrokerEnvFilterTypeToJSON(value.justtrade),
        'comdirect': BrokerEnvFilterTypeToJSON(value.comdirect),
        'flatex': BrokerEnvFilterTypeToJSON(value.flatex),
        'vitrade': BrokerEnvFilterTypeToJSON(value.vitrade),
    };
}

export function RecordBrokerNameEnumBrokerEnvFilterTypeToJSON(value?: RecordBrokerNameEnumBrokerEnvFilterType | null): any {
    return RecordBrokerNameEnumBrokerEnvFilterTypeToJSONRecursive(value, false);
}
