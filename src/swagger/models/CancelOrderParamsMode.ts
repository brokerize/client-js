...
export function CancelOrderParamsModeFromJSON(json: any): CancelOrderParamsMode {
    return CancelOrderParamsModeFromJSONTyped(json, false);
}

export function CancelOrderParamsModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelOrderParamsMode {
    return json as CancelOrderParamsMode;
}

export function CancelOrderParamsModeToJSON(value?: CancelOrderParamsMode | null): any {
    return value as any;
}
