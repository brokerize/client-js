 ...
 */
export interface LoginResultPublic {
    /**
     * 
     * @type {string}
     * @memberof LoginResultPublic
     */
    sessionId: string;
    /**
     * 
...
* @enum {string}
*/
export enum LoginResultPublicStateEnum {
    Challenge = 'challenge'
}

export function LoginResultPublicFromJSON(json: any): LoginResultPublic {
    return LoginResultPublicFromJSONTyped(json, false);
}

export function LoginResultPublicFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoginResultPublic {
...
export function LoginResultPublicToJSON(value?: LoginResultPublic | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
