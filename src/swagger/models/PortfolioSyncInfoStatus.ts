...
export function PortfolioSyncInfoStatusFromJSON(json: any): PortfolioSyncInfoStatus {
    return PortfolioSyncInfoStatusFromJSONTyped(json, false);
}

export function PortfolioSyncInfoStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PortfolioSyncInfoStatus {
    return json as PortfolioSyncInfoStatus;
}

export function PortfolioSyncInfoStatusToJSON(value?: PortfolioSyncInfoStatus | null): any {
    return value as any;
}
