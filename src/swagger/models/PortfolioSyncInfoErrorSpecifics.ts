...
export function PortfolioSyncInfoErrorSpecificsFromJSON(json: any): PortfolioSyncInfoErrorSpecifics {
    return PortfolioSyncInfoErrorSpecificsFromJSONTyped(json, false);
}

export function PortfolioSyncInfoErrorSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PortfolioSyncInfoErrorSpecifics {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'error': !exists(json, 'error') ? undefined : SyncErrorFromJSON(json['error']),
    };
}

export function PortfolioSyncInfoErrorSpecificsToJSONRecursive(value?: PortfolioSyncInfoErrorSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function PortfolioSyncInfoErrorSpecificsToJSON(value?: PortfolioSyncInfoErrorSpecifics | null): any {
