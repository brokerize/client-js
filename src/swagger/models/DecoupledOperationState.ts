...
export function DecoupledOperationStateFromJSON(json: any): DecoupledOperationState {
    return DecoupledOperationStateFromJSONTyped(json, false);
}

export function DecoupledOperationStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): DecoupledOperationState {
    return json as DecoupledOperationState;
}

export function DecoupledOperationStateToJSON(value?: DecoupledOperationState | null): any {
    return value as any;
}
