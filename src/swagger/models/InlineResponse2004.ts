...
} from './InlineResponse2004Exchanges';
...
export interface InlineResponse2004 {
    /**
     * 
     * @type {Array<InlineResponse2004Exchanges>}
...
export function InlineResponse2004FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2004 {
    ...
    return {
        ...
        'exchanges': ((json['exchanges'] as Array<any>).map(InlineResponse2004ExchangesFromJSON)),
    };
}
...
export function InlineResponse2004ToJSON(value?: InlineResponse2004 | null): any {
    ...
    return {
        ...
        'exchanges': ((value.exchanges as Array<any>).map(InlineResponse2004ExchangesToJSON)),
    };
}
