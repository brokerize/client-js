...
} from './PortfoliosResponsePortfolios';
...
export interface PortfoliosResponse {
    /**
     * 
     * @type {Array<PortfoliosResponsePortfolios>}
...
export function PortfoliosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PortfoliosResponse {
    ...
    return {
        ...
        'portfolios': ((json['portfolios'] as Array<any>).map(PortfoliosResponsePortfoliosFromJSON)),
    };
}
...
export function PortfoliosResponseToJSON(value?: PortfoliosResponse | null): any {
    ...
    return {
        ...
        'portfolios': ((value.portfolios as Array<any>).map(PortfoliosResponsePortfoliosToJSON)),
    };
}
