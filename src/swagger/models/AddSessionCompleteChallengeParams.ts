...
export function AddSessionCompleteChallengeParamsFromJSON(json: any): AddSessionCompleteChallengeParams {
    return AddSessionCompleteChallengeParamsFromJSONTyped(json, false);
}

export function AddSessionCompleteChallengeParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddSessionCompleteChallengeParams {
