 ...
 */
export interface BrokerLoginFormPasswordField {
    /**
     * 
     * @type {string}
     * @memberof BrokerLoginFormPasswordField
     */
    label: string;
    /**
     * 
...
* @enum {string}
*/
export enum BrokerLoginFormPasswordFieldTypeEnum {
    String = 'string',
    Password = 'password'
}

export function BrokerLoginFormPasswordFieldFromJSON(json: any): BrokerLoginFormPasswordField {
    return BrokerLoginFormPasswordFieldFromJSONTyped(json, false);
}

export function BrokerLoginFormPasswordFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrokerLoginFormPasswordField {
...
export function BrokerLoginFormPasswordFieldToJSON(value?: BrokerLoginFormPasswordField | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
