...
export function GenericTableRowValueAmountSpecificsFromJSON(json: any): GenericTableRowValueAmountSpecifics {
    return GenericTableRowValueAmountSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowValueAmountSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueAmountSpecifics {
...
export function GenericTableRowValueAmountSpecificsToJSONRecursive(value?: GenericTableRowValueAmountSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function GenericTableRowValueAmountSpecificsToJSON(value?: GenericTableRowValueAmountSpecifics | null): any {
