 ...
 */
export interface PartialPickOrderForCreateOrderModelOrValidityOrSize {
    /**
     * 
     * @type {OrderModelOrderCreate}
     * @memberof PartialPickOrderForCreateOrderModelOrValidityOrSize
     */
...
export function PartialPickOrderForCreateOrderModelOrValidityOrSizeFromJSON(json: any): PartialPickOrderForCreateOrderModelOrValidityOrSize {
    return PartialPickOrderForCreateOrderModelOrValidityOrSizeFromJSONTyped(json, false);
}

export function PartialPickOrderForCreateOrderModelOrValidityOrSizeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartialPickOrderForCreateOrderModelOrValidityOrSize {
...
export function PartialPickOrderForCreateOrderModelOrValidityOrSizeToJSON(value?: PartialPickOrderForCreateOrderModelOrValidityOrSize | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
