 ...
 */
export interface LoginResultReadyPublic {
    /**
     * 
     * @type {string}
     * @memberof LoginResultReadyPublic
     */
    sessionId: string;
    /**
     * 
...
* @enum {string}
*/
export enum LoginResultReadyPublicStateEnum {
    Ready = 'ready'
}

export function LoginResultReadyPublicFromJSON(json: any): LoginResultReadyPublic {
    return LoginResultReadyPublicFromJSONTyped(json, false);
}

export function LoginResultReadyPublicFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoginResultReadyPublic {
...
export function LoginResultReadyPublicToJSON(value?: LoginResultReadyPublic | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
