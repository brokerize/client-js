...
export interface BrokerLoginForm {
    /**
     * 
     * @type {BrokerLoginFormPasswordField}
...
export function BrokerLoginFormFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrokerLoginForm {
    ...
    return {
        ...
        'passwordField': !exists(json, 'passwordField') ? undefined : BrokerLoginFormPasswordFieldFromJSON(json['passwordField']),
        'usernameField': !exists(json, 'usernameField') ? undefined : BrokerLoginFormPasswordFieldFromJSON(json['usernameField']),
    };
}
...
export function BrokerLoginFormToJSON(value?: BrokerLoginForm | null): any {
    ...
    return {
        ...
        'passwordField': BrokerLoginFormPasswordFieldToJSON(value.passwordField),
        'usernameField': BrokerLoginFormPasswordFieldToJSON(value.usernameField),
    };
}
