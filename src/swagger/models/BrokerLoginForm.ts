...
export function BrokerLoginFormFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrokerLoginForm {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'passwordField': !exists(json, 'passwordField') ? undefined : BrokerLoginFormFieldFromJSON(json['passwordField']),
        'usernameField': !exists(json, 'usernameField') ? undefined : BrokerLoginFormFieldFromJSON(json['usernameField']),
    };
}

export function BrokerLoginFormToJSONRecursive(value?: BrokerLoginForm | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
