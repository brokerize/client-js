...
export function GenericTableRowValueLinkPortfolioSpecificsFromJSON(json: any): GenericTableRowValueLinkPortfolioSpecifics {
    return GenericTableRowValueLinkPortfolioSpecificsFromJSONTyped(json, false);
}

export function GenericTableRowValueLinkPortfolioSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueLinkPortfolioSpecifics {
...
export function GenericTableRowValueLinkPortfolioSpecificsToJSONRecursive(value?: GenericTableRowValueLinkPortfolioSpecifics | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function GenericTableRowValueLinkPortfolioSpecificsToJSON(value?: GenericTableRowValueLinkPortfolioSpecifics | null): any {
