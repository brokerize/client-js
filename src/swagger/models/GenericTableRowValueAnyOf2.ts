 ...
 */
export interface GenericTableRowValueAnyOf2 {
    /**
     * 
     * @type {Amount}
     * @memberof GenericTableRowValueAnyOf2
     */
    value: Amount;
    /**
     * 
...
* @enum {string}
*/
export enum GenericTableRowValueAnyOf2TypeEnum {
    Amount = 'amount'
}

export function GenericTableRowValueAnyOf2FromJSON(json: any): GenericTableRowValueAnyOf2 {
    return GenericTableRowValueAnyOf2FromJSONTyped(json, false);
}

export function GenericTableRowValueAnyOf2FromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericTableRowValueAnyOf2 {
...
export function GenericTableRowValueAnyOf2ToJSON(value?: GenericTableRowValueAnyOf2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
