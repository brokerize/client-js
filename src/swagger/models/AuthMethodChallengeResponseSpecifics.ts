...
export function AuthMethodChallengeResponseSpecificsFromJSON(json: any): AuthMethodChallengeResponseSpecifics {
    return AuthMethodChallengeResponseSpecificsFromJSONTyped(json, false);
}

export function AuthMethodChallengeResponseSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthMethodChallengeResponseSpecifics {
