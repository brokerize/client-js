...
export function PrepareOAuthRedirectResponseFromJSON(json: any): PrepareOAuthRedirectResponse {
    return PrepareOAuthRedirectResponseFromJSONTyped(json, false);
}

export function PrepareOAuthRedirectResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrepareOAuthRedirectResponse {
