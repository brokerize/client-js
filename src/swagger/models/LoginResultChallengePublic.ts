 ...
 */
export interface LoginResultChallengePublic {
    /**
     * 
     * @type {Challenge}
     * @memberof LoginResultChallengePublic
     */
    challenge: Challenge;
    /**
     * 
...
* @enum {string}
*/
export enum LoginResultChallengePublicStateEnum {
    Challenge = 'challenge'
}

export function LoginResultChallengePublicFromJSON(json: any): LoginResultChallengePublic {
    return LoginResultChallengePublicFromJSONTyped(json, false);
}

export function LoginResultChallengePublicFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoginResultChallengePublic {
...
export function LoginResultChallengePublicToJSON(value?: LoginResultChallengePublic | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
