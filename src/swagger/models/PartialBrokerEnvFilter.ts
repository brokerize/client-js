 ...
 */
export interface PartialBrokerEnvFilter {
    /**
     * 
     * @type {BrokerEnvFilterType}
     * @memberof PartialBrokerEnvFilter
     */
...
export function PartialBrokerEnvFilterFromJSON(json: any): PartialBrokerEnvFilter {
    return PartialBrokerEnvFilterFromJSONTyped(json, false);
}

export function PartialBrokerEnvFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartialBrokerEnvFilter {
...
export function PartialBrokerEnvFilterToJSONRecursive(value?: PartialBrokerEnvFilter | null, ignoreParent = false): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function PartialBrokerEnvFilterToJSON(value?: PartialBrokerEnvFilter | null): any {
    return PartialBrokerEnvFilterToJSONRecursive(value, false);
}
