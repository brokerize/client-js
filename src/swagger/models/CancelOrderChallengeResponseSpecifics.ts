...
export function CancelOrderChallengeResponseSpecificsFromJSON(json: any): CancelOrderChallengeResponseSpecifics {
    return CancelOrderChallengeResponseSpecificsFromJSONTyped(json, false);
}

export function CancelOrderChallengeResponseSpecificsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelOrderChallengeResponseSpecifics {
